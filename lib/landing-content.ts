...
export const CTA = {
  /* The primary CTA no longer navigates into the product: every entry
     point opens the guided-demo gate (see lib/demo-gate.ts). The href is
     a no-JS fallback that lands on the same locked state server-side. */
  primary: { label: "Start Free Discovery", href: "/?demo=locked&source=discovery" },
